      ...
      <div className='container'>
        ...
        <div className='row'>
          <div className='col-md-2'>
            <div className='swatch bg-green' style={{ width: 100, height: 100 }} />
            <label>Green</label>
          </div>
          <div className='col-md-2'>
            <div className='swatch bg-blue' style={{ width: 100, height: 100 }} />
            <label>Blue</label>
          </div>
          <div className='col-md-2'>
            <div className='swatch bg-purple' style={{width: 100, height: 100}} />
            <label>Purple</label>
          </div>
          <div className='col-md-2'>
            <div className='swatch bg-red' style={{ width: 100, height: 100 }} />
            <label>Red</label>
          </div>
          <div className='col-md-2'>
            <div className='swatch bg-yellow' style={{ width: 100, height: 100 }} />
            <label>Yellow</label>
          </div>
          <div className='col-md-2'>
            <div className='swatch bg-orange' style={{width: 100, height: 100}} />
            <label>Orange</label>
          </div>
        </div>
      </div>
