...
class BetaSignup extends Component {
  ...
  handleSave() {
    if (!this.props.validation.isValid && !this.state.showValidation) {
      ...
      this.props.saveInvite(this.props.invite).then(() => {
        this.props.onSaved();
      });
    }
  }
  ...
  render() {
    ...
    return (
      <div className="betaSignup">
        ...
        <p>Are you a brave? Are you willing to help forge this thing from it&lquo;s doughy infancy? Are you awesome?</p>
        <p>Yeah. you&lquo;re awesome. Holler with an email:</p>
