...
export function extractSchema (datasetRef = {}) {
  return datasetRef.dataset && datasetRef.dataset.structure && datasetRef.dataset.structure.schema && datasetRef.dataset.structure.schema.items && datasetRef.dataset.structure.schema.items.items
}
