...
export default class MetadataEditor extends Base {
  ...
  componentWillReceiveProps (nextProps) {
    console.log('MetadataEditor will recieve props')
    console.log(nextProps && nextProps.localDatasetRef && nextProps.localDatasetRef.dataset && nextProps.localDatasetRef.dataset.meta && nextProps.localDatasetRef.dataset.meta.citations)
