    ...
    return (
      <div className={css('wrap')} >
        ...
        <DatasetRouter
          ...
          // state
          onRename={isLocal && isLatestDataset && this.handleRenameDataset}
          onRemove={isLocal && isLatestDataset && this.handleDeleteDataset}
          onAdd={!isLocal && this.handleAddDataset}
          ...
          exportPath={isLocal && this.handleDownloadDataset()}
        />
      </div>
    )
  }
