  ...
  render () {
    ...
    return (
      <Switch>
        ...
        <Route
          path={`${path}`}
          render={props => this.renderDatasetSection(<Overview {...props} datasetRef={datasetRef} profile={profile} url={url} registryVersion={registryVersion} sessionProfile={sessionProfile} />)}
        />
      </Switch>
    )
  }
