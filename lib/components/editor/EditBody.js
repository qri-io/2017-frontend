  ...
  renderEditor () {
    ...
    switch (bodyView) {
      ...
      default:
        return (
          <HotTable
            colHeaders={showHeaders && this.makeColHeaders()}
            // columns={columns}
            // colWidths={100}
            className='editor'
            rowHeaders
      ...
      <div className={css('wrap')}>
        <header className={css('header')}>
          ...
          <div className={css('columnHeaders')}>
            <ValidCheck label='Column Headers' name='columnHeaders' onChange={toggleColumnHeaders} labelTop checked={showHeaders} />
          </div>
          }
        </header>
