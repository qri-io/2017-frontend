...
export default class AddDataset extends Base {
  ...
  handleChange (name, value, e) {
    ...
    const dataset = Object.assign(this.state.dataset, { [name]: value, file_input: file_input })
    this.setState(Object.assign({}, this.state, { dataset }))
  ...
  onDatasetAddSuccess () {
    ...
    this.setState({ message: 'Success! Your dataset was added.', loading: false, dataset: { name: '', files: undefined, file_input: undefined, url: '' } })
  ...
  template (css) {
    const { disabled, dataset, message, loading } = this.state
    return (
