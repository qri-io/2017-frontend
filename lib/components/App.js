...
// Besides loading the TopBar and AppDrag, App is where modals are mounted
// This is also where, on the first open of the app, we load the Welcome
// and ChoosePeername containers
//
// If there is an error loading the backend, App will load AppUnavail
// If the app is still trying to connect to the backend, App will load AppLoading
//
