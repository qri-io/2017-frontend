...
// Base is a class component that impliments aphrodite
// All of our components extend Base
// It is a pure component, which means it handles `shouldComponentUpdate` update for you
// and makes a shallow comparison when props or state changes
// When we extend base, we use the `template(css)` function in place of our usual `render()` function
