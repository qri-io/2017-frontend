...
export default class StructureFormatConfig extends Base {
  constructor (props) {
    super(props);
    ...
    return (
      <div className='form-wrap'>
        ...
        <div>
          ...
          <small><i>Weather CSV body has a header row</i></small>
        </div>
        <br />
        <div>
          ...
          <small><i>Weather CSV data should be interpreted both with &amp; without quoted fields</i></small>
        </div>
        <br />
        <div>
