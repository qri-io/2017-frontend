...
export default class ValidCheck extends Base {
  template (css) {
    const { label, name, className, checked, showError, error, value, helpText, showHelpText, onChange, labelTop, allowEmpty } = this.props
