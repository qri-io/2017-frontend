...
export default class Dataset extends Base {
  ...
  renderBreadcrumb (url, component) {
    const links = [{ 'title': 'dataset', 'url': url }, { 'title': component, 'url': `${url}/${component}` }]
    return (
        ...
        <div className={css('switch')} >
          <Switch>
            ...
            <Route
              ...
              render={props => (
                <div className='datasetContent'>
                  {this.renderBreadcrumb(match.url, 'meta')}
            ...
            <Route
              ...
              render={props => (
                <div className='datasetContent'>
                  {this.renderBreadcrumb(match.url, 'structure')}
            ...
            <Route
              ...
              render={props => (
                <div className='datasetContent'>
                  {this.renderBreadcrumb(match.url, 'commit')}
            ...
            <Route
              ...
              render={props => (
                <div className='datasetContent'>
                  {this.renderBreadcrumb(match.url, 'viz')}
            ...
            <Route
              ...
              render={props => (
                <div className='datasetContent'>
                  {this.renderBreadcrumb(match.url, 'transform')}
            ...
            <Route
              ...
              render={props => (
                <div className={`datasetContent`}>
                  <DatasetSummary {...props} datasetRef={datasetRef} url={match.url} />
                </div>
              )}
            />
