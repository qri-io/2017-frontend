...
class SearchResults extends Base {
  ...
  template (css) {
    ...
    return (
      <div className={`datasetContent ${css('wrap')}`} >
        <div>
          <p>We are currently working on dataset availability. There may be datasets that show up in your search results that are not currently online.</p>
