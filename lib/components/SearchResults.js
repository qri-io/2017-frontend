    ...
    return (
      <div className={css('wrap')}>
        ...
        <div className='col border-right border-top border-bottom'>
          <header />
          <div className='col'>
            <p className={css('text')}>Search looks at the <span className={css('strong')}> title, description,</span> and <span className={css('strong')}> keywords</span> of <span className={css('strong')}> published</span> datasets.</p>
