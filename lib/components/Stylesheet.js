...
export default class Stylesheet extends Base {
  ...
  template (css) {
    ...
    const { stats, statItem, statItemList } = this.props
    return (
      <div id='stylesheet' className={css('stylesheet')}>
        ...
        <div className={css('container')}>
          ...
          <div className='row'>
            <Swatch style={{ backgroundColor: palette.background, border: `1px solid ${palette.gray}` }} title='background' hex={palette.background.toUpperCase()} />
            ...
            <Swatch style={{ backgroundColor: palette.muted }} title='muted' hex={palette.muted.toUpperCase()} />
            <Swatch style={{ backgroundColor: palette.gray }} title='gray' hex={palette.gray.toUpperCase()} />
            <Swatch style={{ backgroundColor: palette.lightGray }} title='light gray' hex={palette.lightGray.toUpperCase()} />
          </div>
          <div className='row'>
        ...
        <div className={css('container')}>
          ...
          <div className='row'>
            <div className='col-md-6'>
              ...
              <button className='btn btn-neutral-bold'>Primary Button</button>
            ...
            <div className='col-md-6' >
              ...
              <StatItemList stats={statItemList} />
            </div>
          </div>
        </div>
        <div className={css('container')}>
        ...
        <div>
          <div className={css('button')} ><Button text='a' color='a' /></div>
          <div className={css('button')} ><Button text='b' color='b' /></div>
          <div className={css('button')} ><Button text='c' color='c' /></div>
          <div className={css('button')} ><Button text='d' color='d' /></div>
          <div className={css('button')} ><Button text='e' color='e' /></div>
          <div className={css('button')} ><Button text='f' color='f' /></div>
          <div className={css('button')} ><Button text='neutral-bold' color='neutral-bold' /></div>
          <div className={css('button')} ><Button text='neutral' color='neutral' /></div>
          <div className={css('button')} ><Button text='neutral-muted' color='neutral-muted' /></div>
          <div className={css('button')} ><Button text='dark' color='dark' /></div>
          <div className={css('button')} ><Button text='loading' loading dropDown color='a' /></div>
          <div className={css('button')} ><Button text='full width' dropDown full color='b' /></div>
        </div>
      </div>
    )
  }
