  ...
  template (css) {
    ...
    return (
      <div className={css('wrap')}>
        ...
        />{this.renderButtons(css)}<div className={css('note')}>{this.state.message || 'All fields optional, except peername. All fields are publically displayed'}</div></div> : <Spinner />}
      </div>
    )
  }
