    ...
    return (
      <div className={css('wrap')}>
        <div className='col border' >
          ...
          {noProfile ? <NoProfile onGoBack={this.handleGoBack} peername={peername} sessionProfile={sessionProfile} /> : profile ? <ProfileBar profile={profile} peer={peer} setProfilePhoto={this.handleSetProfilePhoto} /> : <Spinner />}
        </div>
        <div className='col border-right border-top border-bottom' >
          <header>
            <PageTitle pageTitle='' sectionTitle='datasets' />
          </header>
          <Datasets datasets={datasets} loading={loading} />
        </div>
