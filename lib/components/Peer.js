...
export default class Peer extends Base {
  ...
  componentWillMount () {
    ...
    if (!this.props.peer) {
      this.props.loadPeerById(this.props.peerid)
    }
    if (this.props.datasets.length === 0 && !this.props.noDatasets) {
  ...
  componentWillReceiveProps (nextProps) {
    ...
    if (!nextProps.peer || this.props.peerid !== nextProps.peerid) {
      this.props.loadPeerById(nextProps.peerid)
    }
    if (!nextProps.datasets.length === 0 && !this.props.noDatasets) {
