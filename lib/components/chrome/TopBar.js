...
// TopBar contains links to the back and forwards button,
// the collection, network, and editor pages, the search bar, and links to the
// discord, docs, and the user's profile (as a small profile photo)
