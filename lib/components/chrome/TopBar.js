    ...
    return (
      <div className={css('topbar')} style={layout}>
        <div className={css('no_shrink')}>
          ...
          <Link className={css('nav_button', 'item_spacing', current('/collection'))} to='/collection'>layers</Link>
          <Link className={css('nav_button', 'item_spacing', current('/profiles'))} to='/profiles'>usergroup</Link>
