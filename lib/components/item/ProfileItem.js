...
export default class ProfileItem extends Base {
  template (css) {
    ...
    // when the online indication is plumbed through the backend responses, then we can
    // remove this line, until then, let's assume all available profiles are online
    data['online'] = true
    ...
    return (
      <div className={css('wrap')} >
        ...
        <div className={css('info')}>
          ...
          <Online online={data.online} small style={{marginTop: 2}} />
