...
class Collection extends Base {
  ...
  render () {
    ...
    const { datasets, fetchedAll, stats, loading } = this.props
    return (
      <div className='collection-wrap'>
        <div className='col border'>
          ...
          <Datasets datasets={datasets} loading={loading} fetchedAll={fetchedAll} message={message} showPublishedStatus />
