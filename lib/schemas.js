...
const bodySchema = new schema.Entity('body', {}, { idAttribute: 'path' })
const profileSchema = new schema.Entity('profiles', {}, { idAttribute: 'id' })
const searchSchema = new schema.Entity('search', {}, { idAttribute: 'ID' })
const registryDatasetSchema = new schema.Entity('registry', {}, { idAttribute: 'path' })
...
const Schemas = {
  ...
  REGISTRY_DATASET: registryDatasetSchema,
  REGISTRY_DATASET_ARRAY: new schema.Array(registryDatasetSchema)
}
