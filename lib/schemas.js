...
const jobSchema = new schema.Entity('jobs', {}, { idAttribute: 'name' })
const logSchema = new schema.Entity('logs', {}, { idAttribute: 'name' })
const diffSchema = new schema.Entity('diff', {}, { idAttribute: '' })
...
const Schemas = {
  ...
  JOB: jobSchema,
  JOB_ARRAY: new schema.Array(jobSchema),

  DIFF: diffSchema,

  LOG: logSchema,
  LOG_ARRAY: new schema.Array(logSchema)
}
