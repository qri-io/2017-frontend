...
import {
  ...
  DATASET_TRANSFORM_REQUEST,
  DATASET_TRANSFORM_SUCCESS,
  DATASET_TRANSFORM_FAILURE
...
export function loadTransform (scriptPath) {
  console.log('IN LOAD TRANSFORM')
  return (dispatch) => {
    return dispatch({
      [GET_CAD]: {
        types: [DATASET_TRANSFORM_REQUEST, DATASET_TRANSFORM_SUCCESS, DATASET_TRANSFORM_FAILURE],
        endpoint: scriptPath,
        schema: Schemas.TRANSFORM
      }
    })
  }
}
