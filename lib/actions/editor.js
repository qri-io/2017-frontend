...
export function initDataset (name = '', dataset = {}, transformScript = '', vizScript = '', body = '') {
  return {
...
export function editDataset (path) {
  return (dispatch, getState) => {
    ...
    return new Promise(function (resolve, reject) {
      ...
      .then((nes) => {
        console.log(nes)
        return dispatch(initDataset(nes.name, nes.dataset, nes.transformScript, nes.vizScript, nes.body))
      })
  }
}
...
export function setTransform (tranform = {}) {
  return {
