...
import { PROFILE_BY_NAME_REQUEST, PROFILE_BY_NAME_SUCCESS, PROFILE_BY_ID_REQUEST, PROFILE_BY_ID_SUCCESS } from '../../constants/profiles'
...
describe('Profiles Actions, loadProfileById:', () => {
  ...
  it('creates PROFILE_BY_ID_SUCCESS when fetching profile has been done', () => {
    ...
    var expectedActions = [
      ...
      { type: PROFILE_BY_ID_SUCCESS, response }
    ]
...
describe('Profiles Actions, loadProfileByName:', () => {
  ...
  it('creates PROIFLE_BY_NAME_SUCCESS when fetching profile has been done', () => {
    ...
    const store = mockStore({ entities: {} })
    var expectedActions = [
      { type: PROFILE_BY_NAME_REQUEST },
      { type: PROFILE_BY_NAME_SUCCESS, response }
    ]
