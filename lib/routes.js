...
import RegistryDatasetContainer from './containers/RegistryDataset'
...
export default () => (
  <AppContainer>
    <Switch>
      ...
      <Route path='/network/:peername/:name/at/:network/:hash' component={RegistryDatasetContainer} />
      <Route path='/network/:peername/:name' component={RegistryDatasetContainer} />
