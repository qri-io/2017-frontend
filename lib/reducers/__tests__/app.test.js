...
describe('App Reducer', () => {
  ...
  it('should handle setting location (SET_LOCATION) on initial state', () => {
    const action = {
      type: SET_LOCATION,
      location: '/datasets'
    }
    Reducer(AppReducer).expect(action).toChangeInState({ location: '/datasets' })
  })

  it('should handle setting location (SET_LOCATION) on existing state', () => {
    const action = {
      type: SET_LOCATION,
      location: '/datasets' }
    Reducer(AppReducer).withState(state).expect(action).toChangeInState({ location: '/datasets' })
  })
